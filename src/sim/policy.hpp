...
inline const char* racial_policy_to_string(RacialPolicy p)
{
  switch (p)
  {
    case RacialPolicy::EXECUTE_ONLY:
      return "Execute Phase (<35% HP)";
    case RacialPolicy::ON_COOLDOWN:
...
inline const char* pet_choice_to_string(PetChoice p)
{
  switch (p)
  {
    case PetChoice::SUCCUBUS:
      return "Succubus (Melee + Lash of Pain)";
    case PetChoice::IMP:
      return "Imp (Firebolt)";
    default:
      return "None / Sacrificed";
  }
}
...
inline const char* pet_choice_to_icon(PetChoice p)
{
  ...
  {
    case PetChoice::SUCCUBUS:
      return "Spell_Shadow_SummonSuccubus.png";
    case PetChoice::IMP:
      return "Spell_Shadow_SummonImp.png";
    default:
      return "";
  }
}

enum class PetConstraint : int8_t
{
  AUTO = -1,
  ACTIVE_IMP = 0,
  ACTIVE_SUCCUBUS = 1,
  SAC_IMP = 2,
  SAC_SUCCUBUS = 3,
  DEMONIC_PACT_IMP_SUCC = 4,
  DEMONIC_PACT_SUCC_IMP = 5,
  NO_PET = 6
};

inline const char* pet_constraint_to_string(PetConstraint p)
{
  switch (p)
  {
    case PetConstraint::ACTIVE_IMP:
      return "Active Imp (Firebolt)";
    case PetConstraint::ACTIVE_SUCCUBUS:
      return "Active Succubus (Lash of Pain)";
    case PetConstraint::SAC_IMP:
      return "Sacrificed Imp (+15% Shadow)";
    case PetConstraint::SAC_SUCCUBUS:
      return "Sacrificed Succubus (+15% Fire)";
    case PetConstraint::DEMONIC_PACT_IMP_SUCC:
      return "Demonic Pact (Sac Imp + Active Succubus)";
    case PetConstraint::DEMONIC_PACT_SUCC_IMP:
      return "Demonic Pact (Sac Succubus + Active Imp)";
    case PetConstraint::NO_PET:
      return "No Pet / No Sacrifice";
    default:
...
enum class RotationChoice : uint8_t
{
  ...
  FIRE_DESTRO,   // Fire Destro: Immolate (+25% Incinerate dmg) + Conflagrate + Shadowburn (10% Fire buff) + Incinerate
                 // filler
  ...
  FIRE_DESTRO_NO_CORRUPTION,   // Fire Destro (No Corruption): Immolate + Conflagrate + Shadowburn + Incinerate filler,
                               // no Corruption
  DP_AF_SHADOW_NO_SOUL_FIRE,  // Demonology Shadow (No Soul Fire): Corruption + Bane of Agony + SB filler, no Decimation
                              // Soul Fire
...
inline const char* rotation_choice_to_string(RotationChoice r)
{
  switch (r)
  {
    case RotationChoice::SHADOW_DESTRO:
      return "Shadow Destro - Conflag Weave + Decimation";
    case RotationChoice::SHADOW_DESTRO_2:
      return "Shadow Destro - Conflag Weave";
    case RotationChoice::FIRE_DESTRO:
      return "Fire Destro - Incinerate + Conflag";
    case RotationChoice::DP_AF_SHADOW:
      return "Demonology Shadow - Corruption + Bane + SB";
    case RotationChoice::DP_RUIN_FIRE:
      return "Demonology Fire - Searing Pain";
    case RotationChoice::DEEP_AFFLICTION:
      return "Deep Affliction - Wrack";
    case RotationChoice::SM_RUIN:
      return "Shadow Mastery - DoTs + SB";
    case RotationChoice::DEMONOLOGY_EXECUTE:
      return "Demo Execute - Decimation Soul Fire";
    case RotationChoice::PURE_SHADOW_BOLT:
      return "Pure Shadow Bolt - No DoTs";
    case RotationChoice::AFFLICTION_HYBRID_DOTS:
      return "Affliction Hybrid - Multi-DoT";
    case RotationChoice::SHADOW_AND_FLAME_FIRE_2:
      return "Shadow & Flame Fire - Incinerate + Conflag";
    case RotationChoice::DP_AF_SHADOW_NO_CORRUPTION:
      return "Demonology Shadow - Bane + SB";
    case RotationChoice::FIRE_DESTRO_NO_CORRUPTION:
      return "Fire Destro - Incinerate + Conflag (No Corruption)";
    case RotationChoice::DP_AF_SHADOW_NO_SOUL_FIRE:
      return "Demonology Shadow - Corruption + Bane + SB (No Soul Fire)";
    case RotationChoice::DP_AF_SHADOW_NO_BANE:
      return "Demonology Shadow - Corruption + SB (No Bane)";
    case RotationChoice::DP_AF_SHADOW_NO_SOUL_FIRE_NO_BANE:
      return "Demonology Shadow - Corruption + SB (No Soul Fire, No Bane)";
    case RotationChoice::DEEP_AFFLICTION_SB:
      return "Deep Affliction - Wrack (SB Filler)";
...
inline const char* rotation_choice_description(RotationChoice r)
{
  ...
  {
    case RotationChoice::SHADOW_DESTRO:
      return "5/11/35 Demonic Sacrifice / Agonizing Flames: Sacrifices Imp (+15% Shadow damage), maintains Immolate "
             "and Conflagrate for Shadow & Flame (+10% Shadow damage for 20s), casts Shadowburn, and spams Shadow "
             "Bolt.";
    case RotationChoice::SHADOW_DESTRO_2:
      return "maintains Immolate and Conflagrate for Shadow & Flame (+10% Shadow damage for 20s), casts Shadowburn, "
             "and spams Shadow Bolt.";
    case RotationChoice::FIRE_DESTRO:
      return "Maintains Immolate for +25% Incinerate damage, casts Conflagrate on CD, weaves Shadowburn for +10% Fire "
             "buff, and spams Incinerate.";
    case RotationChoice::DP_AF_SHADOW:
      return "Demonic Pact / Agonizing Flames Shadow: Sacrifices Imp (+15% Shadow) and summons Succubus (+10% Shadow "
             "from Master Demonologist + 60 SP from Demonic Knowledge). Maintains Corruption and Bane of Agony (CoA), "
             "and spams Shadow Bolt.";
    case RotationChoice::DP_RUIN_FIRE:
      return "Fire Demonic Pact / Agonizing Flames: Maintains Immolate, casts Conflagrate on CD, weaves Shadowburn, "
             "spams Searing Pain (benefiting from Agonizing Flames & Demonic Brand), and feeds pet mana via Demonic "
             "Energies.";
    case RotationChoice::DEEP_AFFLICTION:
    ...
    case RotationChoice::SM_RUIN:
      return "Shadow Mastery / Agonizing Flames (32/0/19): Maintains Corruption and Bane of Agony (CoA) for Nightfall "
             "instant Shadow Bolts and Pandemic crits, casts Shadowburn on cooldown, and spams Shadow Bolt.";
    case RotationChoice::DEMONOLOGY_EXECUTE:
      return "Maintains Corruption and Bane of Agony (CoA) with Shadow Bolt filler until boss reaches <35% HP, then "
             "spams rapid Decimation Soul Fires.";
    case RotationChoice::PURE_SHADOW_BOLT:
      return "Strictly spams Shadow Bolt without placing any DoTs (ideal for Classic 16 debuff limit). Raid curses are "
             "handled by raid debuffs.";
    case RotationChoice::AFFLICTION_HYBRID_DOTS:
      return "Maintains Bane of Agony, Corruption, and Immolate concurrently for maximum multi-DoT DPS, filling with "
             "Wrack and Shadow Bolt.";
    case RotationChoice::SHADOW_AND_FLAME_FIRE_2:
      return "Shadow and Flame Fire 2: Maintains Immolate for +25% Incinerate damage, casts Conflagrate on CD, "
             "maintains Corruption, weaves Shadowburn for +10% Fire buff, and spams Incinerate as filler with active "
             "Imp (no Searing Pain or Soul Fire).";
    case RotationChoice::SHADOW_AND_FLAME_FIRE_BANE:
      return "Shadow and Flame Fire (with Bane): Maintains Immolate for +25% Incinerate damage, casts Conflagrate on "
             "CD, maintains Corruption and Bane of Doom (>60s left) / Bane of Agony (<=60s left), weaves Shadowburn "
             "for +10% Fire buff, and spams Incinerate as filler.";
    case RotationChoice::DP_AF_SHADOW_NO_CORRUPTION:
      return "Demonology Shadow variant that skips Corruption entirely. Maintains only Bane of Agony and spams Shadow "
             "Bolt as filler - useful when Corruption's debuff slot is not available or its DPS contribution is "
             "outweighed by omitting it.";
    case RotationChoice::FIRE_DESTRO_NO_CORRUPTION:
      return "Fire Destro variant that drops Corruption. Maintains Immolate, casts Conflagrate on CD, weaves "
             "Shadowburn for +10% Fire buff, and spams Incinerate - useful when the Corruption debuff slot is not "
             "available.";
    case RotationChoice::DP_AF_SHADOW_NO_SOUL_FIRE:
      return "Demonology Shadow variant without Soul Fire execute. Maintains Corruption and Bane of Agony, and spams "
             "Shadow Bolt as filler - identical to the base DP/AF Shadow rotation but without the Decimation Soul Fire "
             "execute phase.";
    case RotationChoice::DP_AF_SHADOW_NO_BANE:
      return "Demonology Shadow variant without Bane of Agony. Maintains only Corruption and spams Shadow Bolt as "
             "filler - useful when the Bane of Agony debuff slot is not available or is better used by another class.";
    case RotationChoice::DP_AF_SHADOW_NO_SOUL_FIRE_NO_BANE:
...
struct PolicyConfig
{
  ...
  std::vector<PriorityRule> get_priority_rules(const Talents& talents, Race race = Race::UNDEAD) const
  {
    ...
    auto add_racial = [&]()
    {
      ...
      if (race == Race::GNOME)
      {
        rules.push_back({PriorityAction::RACIAL_EUREKA,
      ...
      {
        rules.push_back({PriorityAction::RACIAL_BLOOD_FURY,
      ...
      {
        rules.push_back({PriorityAction::RACIAL_BERSERKING,
    ...
    auto add_nightfall = [&]()
    {
      ...
      {
        rules.push_back({PriorityAction::NIGHTFALL_SHADOW_BOLT,
                         SpellID::SHADOW_BOLT,
    ...
    auto add_decimation = [&](bool include_searing_pain_trigger = true)
    {
      if (talents.demo.decimation > 0 || use_decimation_soul_fire)
      {
        ...
        {
          rules.push_back({PriorityAction::DECIMATION_SEARING_PAIN,
                           SpellID::SEARING_PAIN,
                           "Decimation Trigger (Searing Pain)",
                           "Target HP < 35% & Decimation Inactive",
                           "Trigger when: Boss is below 35% health AND Decimation 10s buff is inactive, casting "
                           "Searing Pain to activate Decimation.",
                           "Fast Searing Pain cast on execute to activate Decimation's Soul Fire cast time reduction "
                           "and 0-shard cost."});
        }
        rules.push_back({PriorityAction::DECIMATION_SOUL_FIRE,
                         SpellID::SOUL_FIRE,
                         "Decimation Soul Fire",
                         "Target HP < 35% & Decimation Active",
                         "Trigger when: Boss is below 35% health AND Decimation buff is active on player AND Soul Fire "
                         "CD is ready.",
    ...
    auto add_corruption = [&]()
    {
      ...
      {
        rules.push_back({PriorityAction::CORRUPTION,
                         SpellID::CORRUPTION,
                         "Corruption",
                         "DoT Expired / Missing",
    ...
    auto add_conflagrate = [&]()
    {
      ...
      {
        rules.push_back({PriorityAction::CONFLAGRATE,
                         SpellID::CONFLAGRATE,
                         "Conflagrate",
    ...
    auto add_shadowburn = [&]()
    {
      ...
      {
        rules.push_back({PriorityAction::SHADOWBURN,
                         SpellID::SHADOWBURN,
                         "Shadowburn",
                         shadowburn == ShadowburnPolicy::ON_COOLDOWN ? "CD Ready (8s)" : "Target HP < 20% (Execute)",
                         shadowburn == ShadowburnPolicy::ON_COOLDOWN
    ...
    {
      rules.push_back({PriorityAction::DRAIN_LIFE_FILLER,
                       SpellID::DRAIN_LIFE,
                       "Drain Life",
                       "Primary Filler",
                       "Trigger when: No higher priority DoT refresh or Nightfall proc is available.",
                       "Channeled Shadow drain benefiting from Improved Drains (+18%), Soul Siphon (+50% tick speed), "
                       "Pandemic (200% crits), and proccing Nightfall."});
    };

    auto add_drain_soul_filler = [&]()
    {
      rules.push_back({PriorityAction::DRAIN_SOUL_FILLER,
                       SpellID::DRAIN_SOUL,
                       "Drain Soul",
                       "Primary Filler",
                       "Trigger when: No higher priority DoT refresh or Nightfall proc is available.",
                       "Channeled Shadow drain benefiting from Improved Drains (+18%, tripled <20% HP), Soul Siphon "
                       "(+50% tick speed), Pandemic (200% crits), and proccing Nightfall."});
    };
