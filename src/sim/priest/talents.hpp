...
inline const std::array<TalentNodeDef, 18>& get_disc_nodes() {
    static const std::array<TalentNodeDef, 18> nodes = {
        TalentNodeDef{"discipline", "Discipline", 1, 1, 5, "spell_holy_wordfortitude", nullptr, {"Your Smite and Penance spells deal 2% increased damage to targets afflicted with your Holy Fire.", "Your Smite and Penance spells deal 4% increased damage to targets afflicted with your Holy Fire.", "Your Smite and Penance spells deal 6% increased damage to targets afflicted with your Holy Fire.", "Your Smite and Penance spells deal 8% increased damage to targets afflicted with your Holy Fire.", "Your Smite and Penance spells deal 10% increased damage to targets afflicted with your Holy Fire."}},
        ...
        TalentNodeDef{"penance", "Penance", 5, 2, 1, "spell_holy_penance", nullptr, {"Launches a volley of holy light at the target, causing 81 Holy damage to an enemy, or 184 healing to an ally, instantly and every 1 sec for 2 sec.", nullptr, nullptr, nullptr, nullptr}},
...
inline const std::array<TalentNodeDef, 17>& get_holy_nodes() {
    static const std::array<TalentNodeDef, 17> nodes = {
        TalentNodeDef{"holy", "Holy", 1, 1, 3, "spell_holy_holybolt", nullptr, {"Gives you a 23% chance to avoid interruption caused by damage while casting any spell.", "Gives you a 47% chance to avoid interruption caused by damage while casting any spell.", "Gives you a 70% chance to avoid interruption caused by damage while casting any spell.", nullptr, nullptr}},
        ...
        TalentNodeDef{"holy_nova", "Holy Nova", 3, 1, 1, "spell_holy_holynova", nullptr, {"Causes an explosion of holy light around the caster, causing 26 to 30 Holy damage to all enemy targets within 10 yards and healing all party members within 10 yards for 50 to 57. These effects cause no threat.", nullptr, nullptr, nullptr, nullptr}},
        ...
        TalentNodeDef{"binding_heal", "Binding Heal", 4, 4, 1, "spell_holy_blindingheal", nullptr, {"Heals a friendly target and the caster for 236 to 284. Low threat.", nullptr, nullptr, nullptr, nullptr}},
...
inline const std::array<TalentNodeDef, 18>& get_shadow_nodes() {
    static const std::array<TalentNodeDef, 18> nodes = {
        ...
        TalentNodeDef{"mind_flay", "Mind Flay", 3, 3, 1, "spell_shadow_siphonmana", nullptr, {"Assault the target's mind with Shadow energy, causing 63 Shadow damage over 3 sec and slowing their movement speed by 50%.", nullptr, nullptr, nullptr, nullptr}},
