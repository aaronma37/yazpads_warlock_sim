...
inline const std::vector<SpecPreset>& standard_spec_presets() {
    static const std::vector<SpecPreset> presets = {
        ...
        {"deep_aff", "40/11/0 Deep Affliction DS-Imp", "Deep Affliction",
            &Talents::create_forever_deep_affliction, RotationChoice::DEEP_AFFLICTION, PetChoice::NONE, false, true, true},
        ...
        {"sf_shadow", "2/17/32 Shadow and Flame Shadow", "Shadow and Flame Shadow 2",
            &Talents::create_forever_shadow_and_flame_shadow_2, RotationChoice::SHADOW_DESTRO_2, PetChoice::IMP, false, false, true},
