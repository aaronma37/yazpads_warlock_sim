...
inline const std::array<TalentNodeDef, 19> FOREVER_DEMONOLOGY_NODES = {{
    ...
    {"demonic_brand", "Demonic Brand", 4, 4, 3, "ability_demonhunter_chaoticimprint_fire.png", nullptr, {"Your Searing Pain generates 17% less threat and brands the target for 10 sec. Your pet's next attack against the target generates high threat and deals 65 to 68 Fire or Shadow damage based on the pet.", "Your Searing Pain generates 33% less threat and brands the target for 10 sec. Your pet's next 2 attacks against the target generate high threat and deal 65 to 68 Fire or Shadow damage based on the pet.", "Your Searing Pain generates 50% less threat and brands the target for 10 sec. Your pet's next 3 attacks against the target generate high threat and deal 65 to 68 Fire or Shadow damage based on the pet.", nullptr, nullptr}},
