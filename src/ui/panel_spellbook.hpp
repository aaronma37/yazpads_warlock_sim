    ...
    static const std::vector<SpellBookEntry> entries = {
        {
            ...
            "Damage = Roll(253, 283) + (SpellPower + ShadowSpellPower) * (3.0 / 3.5) * Multipliers",
        ...
        },
        {
            ...
            "Damage = Roll(238, 266) + (SpellPower + ShadowSpellPower) * (1.5 / 3.5) * Multipliers",
        ...
        },
        {
            ...
            "42.86% Direct (1.5 / 3.5)",
            "Damage = Roll(306, 374) + (SpellPower + FireSpellPower) * (1.5 / 3.5) * Multipliers",
        ...
        },
        {
            ...
            "Damage = (Roll(201, 233) + SP * (2.5 / 3.5)) * (Immolate_Active ? 1.25 : 1.0) * Multipliers",
        ...
        },
        {
            ...
            "Soul Fire (Rank 5)",
            "Fire",
            "6.0s (4.0s with Bane, reduced further by Decimation)",
            "335 Mana",
        ...
        },
        {
            ...
            "None",
            "42.86% Direct (1.5 / 3.5)",
            "Damage = Roll(108, 127) + (SpellPower + FireSpellPower) * (1.5 / 3.5) * Multipliers",
