...
inline const std::vector<SpellBookEntry>& get_all_spellbook_entries()
{
  static const std::vector<SpellBookEntry> entries = {
      ...
      {SpellID::SHADOWBURN,
       ...
       "Instant",
       "365 Mana",
       "259 - 289 Direct Damage",
       "None",
       "42.86%",
       "Damage = Roll(259, 289) + (SpellPower + ShadowSpellPower) * 0.42857 * Multipliers",
      ...
      {SpellID::DRAIN_HOPE,
       ...
       "240 Mana",
       "None",
       "216 Total Shadow Damage (6 ticks of 36.0 every 1s)",
       "85.8%",
       "Tick Damage = (36.0 + (SpellPower + ShadowSpellPower) * 0.143) * Multipliers",
      ...
      {SpellID::DRAIN_SOUL,
       ...
       "50.0%",
       "Tick Damage = (84.0 + (SpellPower + ShadowSpellPower) * 0.10) * Multipliers",
